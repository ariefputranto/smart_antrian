...
<header class="main-header">
    ...
    <?= Html::a('<span class="logo-mini">SA</span><span class="logo-lg">' . Yii::$app->name . '</span>', Yii::$app->homeUrl, ['class' => 'logo']) ?>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <p>
                                ...
                                <?= array_keys(Yii::$app->authManager->getRolesByUser(Yii::$app->user->getId()))[0] ?>
